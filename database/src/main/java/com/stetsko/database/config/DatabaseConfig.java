package com.stetsko.database.config;
...
@Configuration
@ComponentScan("com.stetsko.database")
@PropertySource("classpath:app.properties")
@EnableJpaRepositories(basePackages = "com.stetsko.database.repository")
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource dataSource,
        ...
        factory.setPackagesToScan("com.stetsko.database.entity");
        return factory;
    }
